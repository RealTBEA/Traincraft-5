...
public class EntityGWRBrakeVan extends AbstractWorkCart {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_gwr_brakevan", Traincraft.tcTab); 
	...
	@Override
	public float[] rotationPoints(){ return new float[]{3.4f, -3.4f};}
