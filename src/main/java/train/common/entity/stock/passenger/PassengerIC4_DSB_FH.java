...
public class PassengerIC4_DSB_FH extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(new PassengerIC4_DSB_FH(null), Info.modID+":+train_ic4_dsb_fh", Traincraft.tcTab); 
    public PassengerIC4_DSB_FH(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/IC4_DSB_FH.png" , new String[]{} ,"default", "");
    }
