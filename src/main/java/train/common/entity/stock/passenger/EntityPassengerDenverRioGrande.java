...
public class EntityPassengerDenverRioGrande extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+denverriogrande_passenger", Traincraft.tcTab); 
    public EntityPassengerDenverRioGrande(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/drg_passenger_Yellow.png" , new String[]{} ,"Yellow", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/drg_passenger_Red.png" , new String[]{} ,"Red", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/drg_passenger_Green.png" , new String[]{} ,"Green", "");
    }

    @Override
    public String getDefaultSkin(){return "tc:textures/trains/drg_passenger_Yellow.png";}
