...
public class EntityPassengerICE_2class extends EntityRollingStock implements IPassenger {
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/ICE1_2nd_class_White.png" , new String[]{} ,"White", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/ICE1_2nd_class_Blue.png" , new String[]{} ,"Blue", "");
    }
