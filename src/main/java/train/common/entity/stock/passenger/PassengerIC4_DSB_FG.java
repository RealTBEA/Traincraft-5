...
public class PassengerIC4_DSB_FG extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_ic4_dsb_fg", Traincraft.tcTab); 
    public PassengerIC4_DSB_FG(World world, double x, double y, double z) {
    super(world, x, y, z); }
