...
public class EntityCaboose extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityCaboose(null), Info.modID+":+train_caboose", Traincraft.tcTab); 
    public EntityCaboose(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/caboose.png" , new String[]{} ,"default", "");
    }
