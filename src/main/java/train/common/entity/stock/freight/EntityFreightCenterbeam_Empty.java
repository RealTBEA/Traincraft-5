...
public class EntityFreightCenterbeam_Empty extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_freight_empty", Traincraft.tcTab); 
    public EntityFreightCenterbeam_Empty(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/freight_centerbeam_empty_Grey.png";}
