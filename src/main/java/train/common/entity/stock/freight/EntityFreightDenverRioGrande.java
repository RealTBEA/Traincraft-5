...
public class EntityFreightDenverRioGrande extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+denverriogrande_baggage", Traincraft.tcTab); 
    public EntityFreightDenverRioGrande(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/drg_baggage_Yellow.png";}
