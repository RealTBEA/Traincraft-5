...
public class EntityFreightLongCoveredHopper extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_longcoveredhopper", Traincraft.tcTab); 
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/LongCoveredHopper_LightGrey.png";}
