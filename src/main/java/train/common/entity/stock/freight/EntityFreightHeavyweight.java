...
public class EntityFreightHeavyweight extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityFreightHeavyweight(null), Info.modID+":+heavyweight_mailcar", Traincraft.tcTab); 
    public EntityFreightHeavyweight(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/heavyweight_mailcar.png" , new String[]{} ,"default", "");
    }
	...
	@Override
	public float[] rotationPoints(){ return new float[]{3.2f, -3.2f};}
...
return 3;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.1f, -0.68f, 0.0f}};}
    @Override
