...
public class EntityFreightWood extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_transport_wood", Traincraft.tcTab); 
    public EntityFreightWood(World world, double x, double y, double z) {
    super(world, x, y, z); }
