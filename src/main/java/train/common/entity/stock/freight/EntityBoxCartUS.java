...
public class EntityBoxCartUS extends Freight {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_box_us", Traincraft.tcTab); 
    public EntityBoxCartUS(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/boxCartUS_Brown.png";}
