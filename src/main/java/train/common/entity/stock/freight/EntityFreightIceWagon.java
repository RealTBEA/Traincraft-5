...
public class EntityFreightIceWagon extends Freight {
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/icewagon.png" , new String[]{} ,"default", "");
    }
	...
	@Override
	public String[] additionalItemText() { return new String[] {"Cargo: only ice"};}
...
null, 
null, 
new ItemStack(Items.snowball, 9),
