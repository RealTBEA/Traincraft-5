...
public class EntityTenderD51 extends Tender {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityTenderD51(null), Info.modID+":+train_tender_d51", Traincraft.tcTab); 
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/d51_tender.png" , new String[]{} ,"default", "");
    }
...
return 2;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-3.0f, -0.85f, 0.0f}};}
    @Override
