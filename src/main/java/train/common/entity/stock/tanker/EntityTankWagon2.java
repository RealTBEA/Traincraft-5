...
public class EntityTankWagon2 extends LiquidTank {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_tank_blue", Traincraft.tcTab); 
    public EntityTankWagon2(World world, double x, double y, double z) {
    super(world, x, y, z); }
