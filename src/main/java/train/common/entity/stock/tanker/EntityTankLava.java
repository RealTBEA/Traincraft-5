...
public class EntityTankLava extends LiquidTank {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_tank_lava", Traincraft.tcTab); 
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/lavacar_Empty.png" , new String[]{} ,"Empty", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/lavacar_Full.png" , new String[]{} ,"Full", "");
    }

    @Override
    public String getDefaultSkin(){return "tc:textures/trains/lavacar_Empty.png";}
	...
	@Override
	public String[] additionalItemText() { return new String[] {"Lava Capacity: 30000mb"};}
