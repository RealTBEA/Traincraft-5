...
public class EntityPropagandaUS extends EntityRollingStock {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+propaganda_us", Traincraft.tcTab); 
    public EntityPropagandaUS(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_US_Blue.png" , new String[]{} ,"Blue", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_US_White.png" , new String[]{} ,"White", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_US_Red.png" , new String[]{} ,"Red", "");
    }

    @Override
    public String getDefaultSkin(){return "tc:textures/trains/propaganda_US_Blue.png";}
