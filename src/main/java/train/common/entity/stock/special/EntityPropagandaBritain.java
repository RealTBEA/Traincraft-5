...
public class EntityPropagandaBritain extends EntityRollingStock {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+propaganda_british", Traincraft.tcTab); 
    public EntityPropagandaBritain(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Britain_Blue.png" , new String[]{} ,"Blue", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Britain_White.png" , new String[]{} ,"White", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Britain_Yellow.png" , new String[]{} ,"Yellow", "");
    }

    @Override
    public String getDefaultSkin(){return "tc:textures/trains/propaganda_Britain_Blue.png";}
