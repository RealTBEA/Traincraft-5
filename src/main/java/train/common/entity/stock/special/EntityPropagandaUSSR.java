...
public class EntityPropagandaUSSR extends EntityRollingStock {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+propaganda_ussr", Traincraft.tcTab); 
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/propaganda_USSR_Blue.png";}
