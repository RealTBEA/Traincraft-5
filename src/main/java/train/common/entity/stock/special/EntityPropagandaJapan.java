...
public class EntityPropagandaJapan extends EntityRollingStock {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+propaganda_japan", Traincraft.tcTab); 
    public EntityPropagandaJapan(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Japan_Red.png" , new String[]{} ,"Red", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Japan_White.png" , new String[]{} ,"White", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/propaganda_Japan_Yellow.png" , new String[]{} ,"Yellow", "");
    }

    @Override
    public String getDefaultSkin(){return "tc:textures/trains/propaganda_Japan_Red.png";}
