...
public class EntityLocoSteamC41T extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteamC41T(null), Info.modID+":+train_c41t", Traincraft.tcTab); 
    public EntityLocoSteamC41T(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoC41t.png" , new String[]{} ,"default", "");
    }
