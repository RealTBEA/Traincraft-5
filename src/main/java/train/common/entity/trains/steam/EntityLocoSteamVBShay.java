...
public class EntityLocoSteamVBShay extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteamVBShay(null), Info.modID+":+train_vbshay", Traincraft.tcTab); 
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/vbshay.png" , new String[]{} ,"default", "");
    }
	...
	@Override
	public float[] rotationPoints(){ return new float[]{0.0f, -0.5f};}
...
return 1;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.0f, -0.7f, 0.0f}};}
    @Override
    ...
    return new TrainParticle[]{
            new TrainParticle("largesmoke", 20, new double[]{0.55, 2.2, 0.0}),
    ...
    @Override
    public int getOverheatTime(){return 100;}
