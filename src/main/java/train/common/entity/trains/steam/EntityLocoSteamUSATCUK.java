...
public class EntityLocoSteamUSATCUK extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_S100UK", Traincraft.tcTab); 
    public EntityLocoSteamUSATCUK(World world, double x, double y, double z) {
    super(world, x, y, z); }
...
return 1;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.0f, 0.2f, 0.8375f}};}
    @Override
