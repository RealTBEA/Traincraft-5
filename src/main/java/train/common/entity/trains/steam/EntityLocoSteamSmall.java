...
public class EntityLocoSteamSmall extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteamSmall(null), Info.modID+":+train_steam_small", Traincraft.tcTab); 
    public EntityLocoSteamSmall(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/loco3_Blue.png" , new String[]{} ,"Blue", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/loco3_Red.png" , new String[]{} ,"Red", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/loco3_Green.png" , new String[]{} ,"Green", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/loco3_Yellow.png" , new String[]{} ,"Yellow", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/loco3_Black.png" , new String[]{} ,"Black", "");
    }
...
return 1;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-0.99f, 0.0f, 0.0f}};}
    @Override
    ...
    return new TrainParticle[]{
            new TrainParticle("smoke", 20, new double[]{1.69, 1.1, 0.0}),
            new TrainParticle("explode", 2, new double[]{1.6, -0.4, 0.8}),
    };
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tc:steam_horn", 0.5f,1f, 0);}
