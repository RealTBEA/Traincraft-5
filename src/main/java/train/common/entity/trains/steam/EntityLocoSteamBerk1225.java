...
public class EntityLocoSteamBerk1225 extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteamBerk1225(null), Info.modID+":+Berkshire1225", Traincraft.tcTab); 
    public EntityLocoSteamBerk1225(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/Berk1225_Locomotive.png" , new String[]{} ,"default", "");
    }
	...
	@Override
	public float[] rotationPoints(){ return new float[]{0.0f, -4.25f};}
...
new ItemStack(ItemIDs.firebox.item, 3), 
null,
...
return 2;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.0f, 0.14999998f, 0.0625f}};}
    @Override
    ...
    return new TrainParticle[]{
            new TrainParticle("largesmoke", 20, new double[]{4.65, 1.7, 0.0}),
            new TrainParticle("explode", 2, new double[]{4.2, -0.4, 0.8}),
    };
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tc:class62_horn", 0.6f,1f, 0);}
