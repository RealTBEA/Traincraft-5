...
public class EntityLocoSteamD51Long extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_loco_d51", Traincraft.tcTab); 
    public EntityLocoSteamD51Long(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/d51_long_Black.png";}
