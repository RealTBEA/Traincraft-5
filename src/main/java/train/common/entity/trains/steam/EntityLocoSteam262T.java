...
public class EntityLocoSteam262T extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteam262T(null), Info.modID+":+train_262t", Traincraft.tcTab); 
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/262t.png" , new String[]{} ,"default", "");
    }
...
return 1;
    ...
    return new TrainParticle[]{
            new TrainParticle("smoke", 20, new double[]{2.65, 1.7, 0.0}),
            new TrainParticle("explode", 2, new double[]{2.8, -0.4, 0.8}),
    };
