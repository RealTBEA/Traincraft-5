...
public class EntityLocoSteamC62Class extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoSteamC62Class(null), Info.modID+":+train_loco_c62_class", Traincraft.tcTab); 
    public EntityLocoSteamC62Class(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/c62_engine_Black.png" , new String[]{} ,"Black", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/c62_engine_Red.png" , new String[]{} ,"Red", "");
    }
...
@Override
    ...
    return new TrainParticle[]{
            new TrainParticle("largesmoke", 3, new double[]{5.0, 1.75, 0.0}),
