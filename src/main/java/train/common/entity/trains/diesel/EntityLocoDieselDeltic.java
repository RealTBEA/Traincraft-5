...
public class EntityLocoDieselDeltic extends DieselTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoDieselDeltic(null), Info.modID+":+train_deltic", Traincraft.tcTab); 
    public EntityLocoDieselDeltic(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/Deltic.png" , new String[]{} ,"default", "");
    }
	...
	@Override
	public float[] rotationPoints(){ return new float[]{0.0f, -4.7f};}
...
return 2;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.25f, -1.3f, 0.0f}};}
    @Override
    ...
    return new TrainParticle[]{
            new TrainParticle("largesmoke", 1, new double[]{2.3, 1.6, 0.0}),
    };
