...
public class EntityLocoDieselEMDF3 extends DieselTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(Info.modID+":+train_emdf3", Traincraft.tcTab); 
    public EntityLocoDieselEMDF3(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    @Override
    public String getDefaultSkin(){return "tc:textures/trains/emdf3_Yellow.png";}
