...
public class EntityLocoElectricMinetrain extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricMinetrain(null), Info.modID+":+train_mine_train", Traincraft.tcTab); 
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoMinetrain.png" , new String[]{} ,"default", "");
    }
...
@Override
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tc:tram_horn", 0.8f,1f, 0);}
