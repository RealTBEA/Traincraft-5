...
public class EntityLocoElectricE10_DB extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricE10_DB(null), Info.modID+":+train_e10db", Traincraft.tcTab); 
    public EntityLocoElectricE10_DB(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoe10_db_Blue.png" , new String[]{} ,"Blue", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoe10_db_Red.png" , new String[]{} ,"Red", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoe10_db_Grey.png" , new String[]{} ,"Grey", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoe10_db_Brown.png" , new String[]{} ,"Brown", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/locoe10_db_Green.png" , new String[]{} ,"Green", "");
    }
...
return 3;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-1.7f, -0.55f, 0.0f}};}
    @Override
