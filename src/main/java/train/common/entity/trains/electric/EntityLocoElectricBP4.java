...
public class EntityLocoElectricBP4 extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricBP4(null), Info.modID+":+train_bp4", Traincraft.tcTab); 
    public EntityLocoElectricBP4(World world, double x, double y, double z) {
    super(world, x, y, z); }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/bp4_Green.png" , new String[]{} ,"Green", "");
        SkinRegistry.addSkin(this.getClass(), Info.modID,"textures/trains/bp4_Purple.png" , new String[]{} ,"Purple", "");
    }
...
return 3;
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.2f, -0.65f, 0.0f}};}
    @Override
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tc:nathan_k5La_3", 0.8f,1f, 0);}
