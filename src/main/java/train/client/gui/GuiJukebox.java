...
public class GuiJukebox extends GuiScreen {
    ...
    protected void drawCreativeTabHoveringText(String str, int t, int g) {
        ...
        fontRenderer.drawStringWithShadow("Current state: " + (jukebox.locked ? "Locked" : "Unlocked"), t + 15, g + 30 - 40, -1);
        fontRenderer.drawStringWithShadow("Owner: " + jukebox.getTrainOwner(), t + 15, g + 40 - 40, -1);
    }
